...
public class CharacterController2D : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        Collider2D[] colliders = Physics2D.OverlapBoxAll(m_GroundCheck.position, new Vector2(0.4f,0.075f), m_WhatIsGround);
    ...
    {
        // If crouching or not in the air, check to see if the character can stand up
